...
def test_search_by_person(transactions_list):
    ...
    assert res == [{'Дата операции': '22.01.2026 14:30:00', 'Сумма операции': -1000, 'Номер карты': '*4444',
                   ...
                   {'Дата операции': '28.01.2026 18:45:00', 'Сумма операции': -2000, 'Номер карты': '*2222',
                    'Категория': 'Переводы', 'Кэшбэк': 0, 'Описание': 'Анна П.'},
                   {'Дата операции': '14.02.2026 16:20:00', 'Сумма операции': -3000, 'Номер карты': '*4444',
                    'Категория': 'Переводы', 'Кэшбэк': 0, 'Описание': 'Сергей В.'},
                   {'Дата операции': '05.03.2026 19:30:00', 'Сумма операции': -800, 'Номер карты': '*4444',
                    'Категория': 'Переводы', 'Кэшбэк': 0, 'Описание': 'Ольга К.'}]
